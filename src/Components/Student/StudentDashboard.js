     ...
     <View style={styles.headContiner}> 
      <View style={styles.Maincontainer}>
        ...
        <View style = { styles.mainView }>
          <TouchableOpacity 
          onPress = {()=>{ this.props.navigation.navigate('StudentVerificationForm') }}
          style = { styles.cardView }>
            <Image source={require('../../img/1.png')} style={{width: 60 , height: 60 , tintColor:'white'}} />
            <Text style = { styles.cardText}>Verification Form</Text>
          </TouchableOpacity>


          <TouchableOpacity 
          onPress = {()=>{ this.props.navigation.navigate('StudentAccepted') }}
          style = { styles.cardView }>
            <Image source={require('../../img/2.png')} style={{width: 60 , height: 60 , tintColor:'white'}} />
            <Text style = { styles.cardText}>Company Status</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.Maincontainer}>
        ...
        <View style = { styles.mainView}>
          <TouchableOpacity 
          onPress = {()=>{ this.props.navigation.navigate('StudentProvidedCompany') }}
          style = { styles.cardView}>
            <Image source={require('../../img/3.png')} style={{width: 60 , height: 60 , tintColor:'white'}} />
            <Text style = { styles.cardText}>Provided Company</Text>
          </TouchableOpacity>


          <TouchableOpacity 
          onPress = {()=>{ this.props.navigation.navigate('StudentOfferLatter') }}
          style = { styles.cardView }>
            <Image source={require('../../img/4.png')} style={{width: 60 , height: 60 , tintColor:'white'}} />
            <Text style = { styles.cardText}>Offer Latter</Text>
          </TouchableOpacity>
